...
/**
 * RESTAURADO ao roteiro completo de 164 itens (seções 3.1 a 3.15), após
 * confirmação cruzada: o cadastro anterior havia sido reduzido para 50 itens
 * (planilha "ST1/ST2/ST3"), organizados só em Requisitos Comuns + Específicos
 * por tipo — mas essa reorganização, ao juntar vários artigos num único
 * item, OMITIA capítulos inteiros da RDC 978/2025 que não são exclusivos de
 * um tipo (Serviço de EAC Itinerante, arts. 43-53; Central de Distribuição,
 * arts. 144-153) e perdia granularidade em outros. O modelo de 164 itens bate
 * exatamente com o roteiro oficial (planilha com colunas Nº/Requisito
 * verificável/Base/Sim/Não/N.A./Evidência) e reflete a estrutura real da
 * RDC 978/2025 — que trata a maior parte dos requisitos (gestão da
 * qualidade, contratos, riscos, documentos, processos operacionais, GCQ) de
 * forma UNIFICADA para todo "Serviço que executa EAC", reservando seções
 * próprias só para o que de fato é exclusivo de cada tipo (classificação),
 * do Itinerante e da Central de Distribuição — verificado artigo a artigo
 * contra o texto integral da RDC 978/2025.
 *
 * RDC 978/2025 revoga a RDC nº 786/2023 (art. 193). A fonte é Sim/Não/N.A.
 * (mesmo modelo do sistema, sem adaptação) e não traz coluna de
 * criticidade própria — a classificação I/N/R é julgamento próprio,
 * priorizando regularização/habilitação/segurança do paciente como
 * imprescindíveis.
 */
