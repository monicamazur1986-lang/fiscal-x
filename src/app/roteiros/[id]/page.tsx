...
import { GerarAutuacaoDialog } from "@/components/roteiros/gerar-autuacao-dialog"
...
/**
 * SUBSTITUÍDO pelo roteiro oficial "exclusivo da RDC 978/2025" (planilha
 * ST1/ST2/ST3) — o cadastro anterior (164 itens, seções 3.1 a 3.15) foi
 * transcrito de um PDF diferente e mais genérico; este é o que a fonte
 * correta organiza. RDC 978/2025 revoga a RDC nº 786/2023 (art. 193) e é a
 * base legal dos Serviços de Exames de Análises Clínicas (EAC) — Tipo I
 * (ST1), Tipo II (ST2) e Tipo III (ST3).
 *
 * A fonte tem "Requisitos comuns" (23 itens) e "Requisitos específicos" por
 * tipo (8 para ST1, 9 para ST2, 10 para ST3) — mas os 23 comuns são o MESMO
 * texto nos três blocos ST1/ST2/ST3 da planilha, só renumerado (ST1-001,
 * ST2-001, ST3-001...). Listar 3 vezes o mesmo item seria puro ruído, então
 * aqui os comuns aparecem uma única seção, e cada tipo tem só a sua seção de
 * específicos — o fiscal responde os comuns uma vez e completa com a seção
 * do tipo de serviço que está inspecionando.
 *
 * A fonte é Sim/Não/NA (mesmo modelo do sistema, sem adaptação) e não traz
 * coluna de criticidade — a classificação I/N/R é julgamento próprio,
 * priorizando classificação do serviço, habilitação/RT, restrições
 * exclusivas de cada tipo e segurança do paciente (rastreabilidade,
 * identificação, laudos, CIQ/CEQ) como imprescindíveis.
 */
const rdc978Checklist: ChecklistData = {
  titulo: 'Roteiro de Inspeção Sanitária — RDC Anvisa nº 978/2025',
  subtitulo: 'Serviços de Exames de Análises Clínicas (EAC) — ST1, ST2 e ST3 — revoga a RDC nº 786/2023',
  categoria: 'SAÚDE',
  ...
  secoes: [
    {
      id: 'rdc978-comuns',
      titulo: 'REQUISITOS COMUNS (ST1, ST2 E ST3)',
      itens: [
        { id: 'RDC978-COM-001', crit: 'I', text: 'O serviço está abrangido pela RDC 978 e realiza atividades relacionadas a EAC em material biológico humano? Base legal: RDC 978/2025, arts. 1º a 5º.' },
        { id: 'RDC978-COM-002', crit: 'I', text: 'O Responsável Legal e o Responsável Técnico estão formalmente identificados, habilitados e com responsabilidades definidas? Base legal: RDC 978/2025, art. 5º, XLII e XLIII.' },
        { id: 'RDC978-COM-003', crit: 'I', text: 'Existe supervisor do pessoal técnico legalmente habilitado, presencial durante o funcionamento, com substituto em caso de impedimento? Base legal: RDC 978/2025, art. 5º, XLV, e art. 122.' },
        { id: 'RDC978-COM-004', crit: 'I', text: 'O serviço possui alvará de licenciamento indicando expressamente as atividades de EAC, cadastro no CNES quando aplicável, RT e substituto? Base legal: RDC 978/2025, arts. 73 a 75.' },
        { id: 'RDC978-COM-005', crit: 'N', text: 'Existe estrutura organizacional documentada, política de acesso a dados e informações e avaliação da qualidade dos produtos ou serviços? Base legal: RDC 978/2025, arts. 76 a 78.' },
        { id: 'RDC978-COM-006', crit: 'N', text: 'Os contratos com fornecedores e prestadores definem responsabilidades, controle de qualidade, rastreabilidade, auditoria e comunicação de riscos? Base legal: RDC 978/2025, arts. 79 a 83.' },
        { id: 'RDC978-COM-007', crit: 'I', text: 'O serviço implementou Programa de Garantia da Qualidade (PGQ), com responsabilidades, indicadores de desempenho e avaliação documentada do Controle da Qualidade? Base legal: RDC 978/2025, arts. 84 a 87.' },
        { id: 'RDC978-COM-008', crit: 'I', text: 'Os produtos, equipamentos e tecnologias estão regularizados, identificados, usados conforme fabricante, mantidos, calibrados e com registros de manutenção? Base legal: RDC 978/2025, arts. 88 a 94.' },
        { id: 'RDC978-COM-009', crit: 'N', text: 'Há controle documentado de armazenamento, temperatura, recebimento, validade, identificação e rastreabilidade de reagentes, insumos e produtos para diagnóstico in vitro? Base legal: RDC 978/2025, arts. 95 a 104.' },
        { id: 'RDC978-COM-010', crit: 'N', text: 'O sistema de informação possui controle de acesso, integridade, confidencialidade, rastreabilidade de alterações, liberação de resultados e proteção contra acesso não autorizado? Base legal: RDC 978/2025, arts. 105 e 106.' },
        { id: 'RDC978-COM-011', crit: 'N', text: 'O gerenciamento de riscos identifica, analisa, trata, monitora e comunica riscos, falhas, erros humanos e incidentes, com ações corretivas documentadas? Base legal: RDC 978/2025, arts. 107 a 110.' },
        { id: 'RDC978-COM-012', crit: 'I', text: 'Existe Plano de Gerenciamento de Resíduos e instruções atualizadas de limpeza, desinfecção e esterilização, com produtos regularizados? Base legal: RDC 978/2025, arts. 111 a 114.' },
        { id: 'RDC978-COM-013', crit: 'N', text: 'A documentação é mantida por no mínimo cinco anos, em português, atualizada e disponível, incluindo PBA, procedimentos, inventário, equipe, PGQ e controles de qualidade? Base legal: RDC 978/2025, arts. 115 a 119.' },
        { id: 'RDC978-COM-014', crit: 'N', text: 'A equipe é dimensionada, qualificada e treinada; há Educação Permanente anual, treinamento baseado em riscos, avaliação de eficácia e registros completos? Base legal: RDC 978/2025, arts. 120 a 127.' },
        { id: 'RDC978-COM-015', crit: 'I', text: 'O serviço garante rastreabilidade de todas as atividades da fase pré-analítica e identifica o estabelecimento, o responsável e o CNES no material biológico? Base legal: RDC 978/2025, arts. 128 a 131.' },
        { id: 'RDC978-COM-016', crit: 'I', text: 'O paciente recebe orientações acessíveis sobre preparo e coleta, sua identificação é conferida e existem instruções escritas e atualizadas para os processos pré-analíticos? Base legal: RDC 978/2025, art. 132.' },
        { id: 'RDC978-COM-017', crit: 'N', text: 'O cadastro, atendimento, solicitação, identificação, coleta, acondicionamento e recebimento do material biológico possuem registros completos e rastreáveis? Base legal: RDC 978/2025, arts. 133 a 139.' },
        { id: 'RDC978-COM-018', crit: 'I', text: 'O transporte do material biológico atende à legislação aplicável, mantém integridade, temperatura, identificação e embalagem terciária com informações obrigatórias? Base legal: RDC 978/2025, arts. 140 a 143.' },
        { id: 'RDC978-COM-019', crit: 'I', text: 'A fase analítica possui instruções atualizadas, rastreabilidade, limites críticos, controles da água reagente e métodos baseados no fabricante, literatura ou validação? Base legal: RDC 978/2025, arts. 154 a 156.' },
        { id: 'RDC978-COM-020', crit: 'I', text: 'A fase pós-analítica possui procedimentos para liberação de resultados, assinatura válida, laudo completo, comunicação de resultados críticos, revisão e retificação? Base legal: RDC 978/2025, arts. 165 a 170.' },
        { id: 'RDC978-COM-021', crit: 'I', text: 'O Controle Interno da Qualidade é realizado, documentado, avaliado e mantido para todos os equipamentos e analitos, com critérios de aceitação e ações para resultados rejeitados? Base legal: RDC 978/2025, arts. 171 a 176.' },
        { id: 'RDC978-COM-022', crit: 'N', text: 'O serviço participa de Controle Externo da Qualidade/Ensaio de Proficiência, avalia resultados, investiga não conformidades e mantém registros disponíveis? Base legal: RDC 978/2025, arts. 177 a 184.' },
        { id: 'RDC978-COM-023', crit: 'N', text: 'O serviço possui plano de adequação quando aplicável e atende às disposições finais, sem prejuízo das responsabilidades sanitárias decorrentes do descumprimento? Base legal: RDC 978/2025, arts. 191 a 194.' },
      ]
    },
    {
      id: 'rdc978-st1',
      titulo: 'REQUISITOS ESPECÍFICOS — SERVIÇO TIPO I (ST1)',
      itens: [
        { id: 'RDC978-ST1-024', crit: 'I', text: 'O serviço está corretamente classificado como Serviço Tipo I e executa apenas as atividades permitidas para este tipo? Base legal: RDC 978/2025, arts. 8º a 12.' },
        { id: 'RDC978-ST1-025', crit: 'I', text: 'Executa EAC exclusivamente em material biológico obtido por punção capilar, coleta em cavidade oral, nasofaringe ou orofaringe? Base legal: RDC 978/2025, art. 10, I.' },
        { id: 'RDC978-ST1-026', crit: 'N', text: 'Realiza todas as etapas do processo operacional de EAC no próprio serviço, incluindo Controle Interno e Controle Externo da Qualidade? Base legal: RDC 978/2025, art. 10, II.' },
        { id: 'RDC978-ST1-027', crit: 'I', text: 'Não utiliza metodologia própria, não recebe amostras de outros serviços e não utiliza água reagente produzida no próprio serviço? Base legal: RDC 978/2025, art. 10, III a V.' },
        { id: 'RDC978-ST1-028', crit: 'I', text: 'Os EAC são realizados por profissional legalmente habilitado e a assistência à saúde está relacionada à habilitação do profissional? Base legal: RDC 978/2025, arts. 11 e 12.' },
        { id: 'RDC978-ST1-029', crit: 'N', text: 'A área de recepção é dimensionada e separada da sala de coleta e execução de EAC, com DML, sanitário, sala de coleta e área de execução? Base legal: RDC 978/2025, art. 13.' },
        { id: 'RDC978-ST1-030', crit: 'N', text: 'A sala de coleta e execução dispõe de lavatório, bancada, mesa, cadeira, refrigeração exclusiva quando necessária, termômetro, recipiente para perfurocortantes e resíduos? Base legal: RDC 978/2025, art. 14.' },
        { id: 'RDC978-ST1-031', crit: 'N', text: 'O consultório isolado/farmácia possui condições de compartilhamento permitidas, climatização/ventilação, iluminação adequada e área de procedimento relacionada ao EAC? Base legal: RDC 978/2025, arts. 15 a 18.' },
      ]
    },
    {
      id: 'rdc978-st2',
      titulo: 'REQUISITOS ESPECÍFICOS — SERVIÇO TIPO II (ST2)',
      itens: [
        { id: 'RDC978-ST2-024', crit: 'I', text: 'O serviço está corretamente classificado como Serviço Tipo II e executa apenas as atividades permitidas para este tipo? Base legal: RDC 978/2025, arts. 19 a 22.' },
        { id: 'RDC978-ST2-025', crit: 'I', text: 'Executa EAC exclusivamente em material biológico obtido por punção capilar, coleta em cavidade oral, nasofaringe ou orofaringe? Base legal: RDC 978/2025, art. 22, I.' },
        { id: 'RDC978-ST2-026', crit: 'N', text: 'Realiza todas as etapas do processo operacional de EAC no próprio serviço, incluindo Controle Interno e Controle Externo da Qualidade? Base legal: RDC 978/2025, art. 22, II.' },
        { id: 'RDC978-ST2-027', crit: 'I', text: 'Não utiliza metodologia própria e não utiliza água reagente produzida no próprio serviço? Base legal: RDC 978/2025, art. 22, III e IV.' },
        { id: 'RDC978-ST2-028', crit: 'I', text: 'A coleta de outros materiais biológicos é realizada exclusivamente na fase pré-analítica, sob supervisão de profissional legalmente habilitado? Base legal: RDC 978/2025, art. 23.' },
        { id: 'RDC978-ST2-029', crit: 'N', text: 'O serviço somente coleta, armazena, acondiciona, processa e transporta material biológico no âmbito da realização da fase pré-analítica e mantém condições de armazenamento conforme fabricante? Base legal: RDC 978/2025, arts. 24 a 26.' },
        { id: 'RDC978-ST2-030', crit: 'N', text: 'A infraestrutura possui recepção, DML, sanitário, copa, vestiário, área para pacientes, sala de coleta/execução e sanitário acessível? Base legal: RDC 978/2025, art. 27.' },
        { id: 'RDC978-ST2-031', crit: 'N', text: 'A sala de coleta e execução possui triagem, guarda temporária, lavatório, bancada, mesa, cadeira, refrigeração, termômetros, depósito, climatização e iluminação adequada? Base legal: RDC 978/2025, arts. 28 a 31.' },
        { id: 'RDC978-ST2-032', crit: 'N', text: 'O consultório isolado Tipo II possui área de procedimento exclusiva; quando compartilhado, atende às condições permitidas? Base legal: RDC 978/2025, art. 32.' },
      ]
    },
    {
      id: 'rdc978-st3',
      titulo: 'REQUISITOS ESPECÍFICOS — SERVIÇO TIPO III (ST3)',
      itens: [
        { id: 'RDC978-ST3-024', crit: 'I', text: 'O serviço está corretamente classificado como Serviço Tipo III e realiza os EAC e fases permitidos para este tipo? Base legal: RDC 978/2025, arts. 33 a 35.' },
        { id: 'RDC978-ST3-025', crit: 'N', text: 'Realiza todos os EAC, todas as fases do processo operacional e o envio de material biológico para Laboratório de Apoio quando aplicável? Base legal: RDC 978/2025, art. 35, I a III.' },
        { id: 'RDC978-ST3-026', crit: 'I', text: 'O Laboratório de Apoio está previsto e a prestação de serviços está formalizada por contrato conforme a RDC 978? Base legal: RDC 978/2025, arts. 36 e 37.' },
        { id: 'RDC978-ST3-027', crit: 'N', text: 'O serviço avalia anualmente a regularidade sanitária e a qualidade analítica do Laboratório de Apoio por resultados de Ensaio de Proficiência? Base legal: RDC 978/2025, art. 38.' },
        { id: 'RDC978-ST3-028', crit: 'N', text: 'Quando contrata Laboratório de Apoio fora do Brasil, mantém comprovação de regularidade e tradução juramentada disponível? Base legal: RDC 978/2025, art. 39.' },
        { id: 'RDC978-ST3-029', crit: 'N', text: 'A infraestrutura física atende à RDC 50/2002 e atualizações? Base legal: RDC 978/2025, art. 40.' },
        { id: 'RDC978-ST3-030', crit: 'N', text: 'A sala de coleta e execução possui climatização e iluminação que não prejudica a avaliação do EAC nem a coloração da pele? Base legal: RDC 978/2025, arts. 41 e 42.' },
        { id: 'RDC978-ST3-031', crit: 'N', text: 'Quando utiliza Metodologia Própria, o serviço documenta etapas, insumos, equipamentos, validação, sensibilidade, especificidade, aprovação e resultados? Base legal: RDC 978/2025, arts. 157 a 164.' },
        { id: 'RDC978-ST3-032', crit: 'I', text: 'Os laudos identificam resultados obtidos por Metodologia Própria e o serviço não comercializa ou repassa produtos dessa metodologia, salvo a exceção prevista? Base legal: RDC 978/2025, arts. 159 e 160.' },
        { id: 'RDC978-ST3-033', crit: 'N', text: 'O Serviço Tipo III utiliza amostras controle comercializadas e pode doar material biológico a Provedor de Ensaio de Proficiência somente dentro das condições normativas? Base legal: RDC 978/2025, art. 181, § 2º, e art. 190.' },
      ]
    },
  ]
}
        ...
        <header className="flex flex-wrap items-center justify-between no-print mb-10 gap-3 w-full max-w-[210mm] px-4">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              ...
              {/* Autuação a partir das não conformidades — só depois de
                  finalizar, quando o que é ou não conformidade já está
                  decidido. Abre em diálogo sobre o relatório, com o tipo de
                  documento (intimação, auto de infração, interdição,
                  apreensão/inutilização) escolhido ali: o fiscal não sai da
                  tela nem perde o que estava fazendo. */}
